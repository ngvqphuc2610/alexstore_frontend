...
- [x] **Biểu đồ doanh thu:** Trực quan hóa doanh thu và số đơn hàng theo thời gian (Line Chart, Bar Chart).
...
- [x] **Thông tin gian hàng:** Cập nhật tên Shop, Avatar/Logo, và mô tả ngắn (Bio) của gian hàng. (Đã xong phần Tên và Bio)
- [x] **Địa chỉ lấy hàng:** Thiết lập số điện thoại và địa chỉ thực tế để đơn vị vận chuyển đến lấy hàng. (Đã xong)
