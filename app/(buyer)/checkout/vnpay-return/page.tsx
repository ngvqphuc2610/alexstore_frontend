    ...
    useEffect(() => {
        const verifyPayment = async () => {
            try {
                ...
                const res = await paymentService.verifyVNPay(queryString);
            ...
            <Card className="border border-gray-100 shadow-sm overflow-hidden">
                {status === 'loading' && (
                    <div className="p-12 text-center">
                        ...
                        <h2 className="text-xl font-medium text-gray-900">Đang xác thực thanh toán VNPay...</h2>
                ...
                {status === 'success' && (
                    <>
                        <div className="bg-gradient-to-br from-emerald-500 to-emerald-600 p-8 text-center text-white">
                            ...
                            <h1 className="text-2xl font-bold mb-2">Thanh toán VNPay thành công!</h1>
                            <p className="text-emerald-100 text-sm">Đơn hàng của bạn đã được thanh toán.</p>
                        </div>
                        ...
                        <CardContent className="p-8 text-center">
                            {orderCode && (
                                <p className="text-sm text-gray-600 mb-6">
                                    Đơn hàng <strong>{orderCode}</strong> đang ở trạng thái chờ thanh toán. Bạn có thể thử thanh toán lại trong phần Quản lý đơn hàng.
                                </p>
                            )}
...
export default function VNPayReturnPage() {
    return (
        <Suspense fallback={<div className="p-12 text-center animate-spin rounded-full h-12 w-12 border-b-2 border-primary mx-auto"></div>}>
            <VNPayReturnContent />
        </Suspense>
    );
}
